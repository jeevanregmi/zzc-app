...
export const CONSTITUTION_EXTRACT_STEPS: WorkflowStep[] = [
  {
    id:      "select",
    icon:    "📄",
    labelNp: "संविधान document छान्नुहोस्",
    labelEn: "Select document",
    whyNp:   "Documents page मा Constitution PDF upload गर्नुहोस् — यो पूरा system को आधार हो।",
  },
  {
    id:      "extract-batch",
    icon:    "⚙️",
    labelNp: "संविधानका सबै धाराहरू निकाल्नुहोस्",
    labelEn: "Extract articles",
    whyNp:   "AI ले ३०८ धाराहरू पढ्छ र प्रत्येकको हकहरू, कर्तव्यहरू, र institutions record गर्छ। एकपटक गरे पुग्छ।",
    actionLabel: "संविधान Extract गर्नुहोस्",
  },
  {
    id:      "repair",
    icon:    "🔧",
    labelNp: "धाराहरू सही भागमा मिलाउनुहोस्",
    labelEn: "Fix branch mapping",
    whyNp:   "AI ले देवनागरी अंक गलत पढ्न सक्छ — यो step ले भाग mapping सुधार्छ। AI फेरि चल्दैन, content बदलिँदैन।",
    actionLabel: "भाग-संरचना सुधार गर्नुहोस्",
  ...
  },
  {
    id:      "health",
    icon:    "🌿",
    labelNp: "Branch Health confirm गर्नुहोस्",
    labelEn: "Verify branches",
    whyNp:   "सबै ३५ भागहरूमा धाराहरू देखिनुपर्छ — कुनै भाग खाली देखिए माथिको step दोहोर्याउनुस्।",
    actionLabel: "Branch Health हेर्नुहोस्",
    actionHref:  "/vault/constitution/health",
  },
  {
    id:      "publish",
    icon:    "🌳",
    labelNp: "जनताका लागि Public Tree",
    labelEn: "Public Tree",
